...
# add task file t
alias t='python ~/Downloads/sjl-t-6311beda0836/t.py --task-dir ~/Dropbox/tasks --list tasks'
...
PS1="\u$NO_COLOUR:\w$RED\$(parse_git_branch)$NO_COLOUR\$ "

# edit prompt to add task list
